...
-- Tiempo de generación: 01-08-2024 a las 22:14:52
...
(1, 'EMPRESA SQL', 14, 1, 'DESCRIPCION', 54, 34000000, 5, 100, 1, 'Estatus 14', 3, 1),
(2, 'Timejose  Ceramics', 8, 1, 'setas s a partir de la arcilla,', 21, 27000000, 1200, 2000, 2, 'Anunciada', 8, 1),
(3, 'TITÁN de Biopappel', 26, 2, 'Ampliación de la planta de papel para la fabricación de cajas de cartón.', 69, 1350000000, 350, 1050, 3, 'Anunciada', 8, 1),
(4, 'Torre Ag Air Life', 30, 1, 'Torre de 97 departamentos residenciales con zonas de amenidades.', 48, 363000000, 605, 300, 4, 'Anunciada', 8, 1),
(5, 'ISQUISA', 1, 1, 'Centro de distribución para productos químicos, de limpieza y agroindustriales.', 63, 250000000, 100, 300, 5, 'Anunciada', 8, 1),
(6, 'Nave Tepeji Actualizado', 18, 2, 'Nave industrial multimodal para arrendamiento', 63, 15000000, 100, 50, 6, 'Anunciada', 8, 1),
(7, 'EMPRESA empresa mas', 18, 2, 'Navemultimodal para arrendamiento', 63, 15000000, 100, 50, 6, 'Anunciada', 8, 1);
