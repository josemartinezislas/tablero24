...
(7, 'EMPRESA empresa mas', 3, 2, 'Nave multimodal para arrendamiento', 63, 15000000, 100, 50, 6, 'Anunciada', 8, 1),
(8, 'nuevaEMPRESA', 5, 5, 'descripcion corta', 3, 5656666, 7, 33, 55, 'estado prosp', 2, 4),
(9, 'Ubuntu server 24', 4, 1, 'Sistena departamentos residenciales con zonas de amenidades.', 48, 363000000, 605, 300, 4, 'Anunciada', 8, 1);
